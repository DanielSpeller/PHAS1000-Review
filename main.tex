...
\centering
\begin{tikzpicture}
    \draw[->,black]{(0,0) -- (4,0) node[midway,below]{$\dots\mathbf{\hat{i}}\quad\mathbf{\hat{j}}\quad\mathbf{\hat{k}}\quad\mathbf{\hat{i}}\quad\mathbf{\hat{j}}\quad\mathbf{\hat{k}}\dots$} node [midway, above]{$+$}} ;
    \draw[->,black]{(4,-1) -- (0,-1) node[midway, below]{$-$}};
\end{tikzpicture}
\end{tcolorbox}
...
\begin{tikzpicture}
    ...
    \draw (0.5,0) arc (0:\angle:0.5) node[above, right] {$\theta$};

    \node at (\angle:3.3) [right]{$(1,1)$};
